...
def run_test_practice_problem2a():
    ...
    actual = practice_problem2a([20, 20, 20, 20],5)
    print()
    ...
    # Test 1:
    expected = [15, 51, 10, -8]
    actual = practice_problem2a([20, 56, 15, -2], -5)
    print()
    print('Test 2 expected:', expected)
    print('       actual:  ', actual)

    # Test 1:
    expected = [40, 60, 100, 100]
    actual = practice_problem2a([20, 40, 80, 80], 20)
    print()
    print('Test 3 expected:', expected)
    print('       actual:  ', actual)

    # Test 1:
    expected = [-100, 0, -200, -300]
    actual = practice_problem2a([0, 100, -100, -200], -100)
    print()
